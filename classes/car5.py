...
class Car():
    ...
    def calculate_steering(self, dt):
        ...
        # rear_wheel.x -= self.wheel_base/2
        front_wheel.x += self.wheel_base/2
        ...
        new_heading = (front_wheel).normalize()
        print(f"New Heading: {new_heading}")
        print(f"Heading Rotation1: {new_heading.rotation()}")
        ...
        print(f"Heading Rotation2: {new_heading.rotation()}")
        if d > 0:
        ...
        print(f"Heading Rotation3: {new_heading.rotation()}")
