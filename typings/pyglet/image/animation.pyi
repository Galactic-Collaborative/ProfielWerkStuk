...
class Animation:
    ...
    def add_to_texture_bin(self, texture_bin, border=...): # -> None:
    ...
    def get_transform(self, flip_x=..., flip_y=..., rotate=...): # -> Animation:
    ...
    @classmethod
    def from_image_sequence(cls, sequence, duration, loop=...): # -> Self@Animation:
