...
from .codecs import Source, SourceGroup, StaticSource, StreamingSource, add_default_codecs as _add_default_codecs, have_ffmpeg, registry as _codec_registry
...
def load(filename, file=..., streaming=..., decoder=...): # -> Any:
